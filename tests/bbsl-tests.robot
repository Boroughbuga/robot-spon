...
test11
    ...
    \  should be equal as strings  ${response.status_code}  200
    \  ${techprofile_status}=  Evaluate  [x for x in ${response.json()} if x['name'] == '${tech_profile_name_${i}}']
